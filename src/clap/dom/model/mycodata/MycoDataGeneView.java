...
public class MycoDataGeneView extends DomainObject<Long>{
...
// from mysql table species_list	
	String taxonomic;
	String phylogeny;
// from mysql table ec_annotation
	String commonName;
	String alternateName;
	String definition;
	
	public MycoDataGeneView(Long id, Long enzymeEntryId, Long entryNameId, String species, 
			...
			String taxonomic, String phylogeny,
			String commonName, 	String alternateName, String definition) {
		super(id, 0);
// from mysql table entry_description
