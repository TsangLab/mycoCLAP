...
Ext.ux.grid.filter.NumericFilter = Ext.extend(Ext.ux.grid.filter.Filter, {
			...
			/**
			 * @cfg {Object} fieldCls The Class to use to construct each field
			...
			fieldCls : Ext.form.NumberField,
			/**
			 * @cfg {Object} fieldCfg The default configuration options for any
			 *      field item unless superseded by the
			 *      <code>{@link #fields}</code> configuration. Defaults to:
			 * 
			 * <pre>
			 * fieldCfg : {
			 * }
			 ...
			 */
			/**
			 * @cfg {Object} fields The field items may be configured
			 *      individually Defaults to <tt>undefined</tt>. Example
			 *      usage:
			 * 
			 * <pre><code>
			 * 			fields : {
			 ...
			 */
			/**
			 * @cfg {Object} iconCls The iconCls to be applied to each
			...
			/**
			 * @cfg {Object} menuItemCfgs Default configuration options for each
			...
			/**
			 * @cfg {Array} menuItems The items to be shown in this menu. Items
			 *      are added to the menu according to their position within
