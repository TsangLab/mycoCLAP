 ...
 *          objects from an XML document based on mappings in a provided
 *          {@link Ext.data.Record} constructor.
 *          </p>
 *          <p>
 *          <b>Note</b>: that in order for the browser to parse a returned XML
 *          document, the Content-Type header in the HTTP response must be set
 ...
 * </code></pre>
 * 
 * @cfg {String} totalProperty The DomQuery path from which to retrieve the
 ...
 * @cfg {String} record The DomQuery path to the repeated element which contains
 *      record information.
 * @cfg {String} successProperty The DomQuery path to the success attribute used
 *      by forms.
 * @cfg {String} idPath The DomQuery path relative from the record element to
...
Ext.extend(Ext.data.XmlReader, Ext.data.DataReader, {
	 ...
	 *            document. The response is expected to contain a property
	 *            called <tt>responseXML</tt> which refers to an XML document
	 *            object.
	 ...
	 * 
	 * @param {String}
	 *            action [{@link Ext.data.Api#actions}
	 *            create|read|update|destroy]
	 * @param {Object}
	 *            response HTTP Response object from browser.
	 * @return {Ext.data.Response} response Returns an instance of
	 *         {@link Ext.data.Response}
	 */
	...
	/**
	 * extracts values and type-casts a row of data from server, extracted by
	 * #extractData
	 * 
	 * @param {Hash}
	 *            data
	 * @param {Ext.data.Field[]}
	 *            items
	 * @param {Number}
	 *            len
	 * @private
