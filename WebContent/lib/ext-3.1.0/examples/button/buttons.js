...
Ext.onReady(function() {
			...
			function renderButtons(title) {
				...
				new ButtonPanel('Icon and Text (left)', [{
									text : 'Add User',
									iconCls : 'add16'
								}, {
									text : 'Add User',
				...
				new ButtonPanel('Icon and Text (top)', [{
									text : 'Add User',
									iconCls : 'add16',
									iconAlign : 'top'
								}, {
				...
				new ButtonPanel('Icon and Text (right)', [{
									text : 'Add User',
									iconCls : 'add16',
									iconAlign : 'right'
								}, {
				...
				new ButtonPanel('Icon and Text (bottom)', [{
									text : 'Add User',
									iconCls : 'add16',
									iconAlign : 'bottom'
								}, {
