...
Ext.ux.tree.TreeGridSorter = Ext.extend(Ext.tree.TreeSorter, {
			...
			/**
			 * @cfg {String} sortAscText The text displayed in the 'Sort
			 *      Ascending' menu item (defaults to <tt>'Sort Ascending'</tt>)
			 */
			sortAscText : 'Sort Ascending',
			/**
			 * @cfg {String} sortDescText The text displayed in the 'Sort
