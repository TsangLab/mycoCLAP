...
Ext.ux.grid.RowExpander = Ext.extend(Ext.util.Observable, {
	...
	constructor : function(config) {
		...
		this.addEvents({
					/**
					 * @event beforeexpand Fires before the row expands. Have
					...
					expand : true,
					/**
					 * @event beforecollapse Fires before the row collapses.
					 *        Have the listener return false to prevent the row
					 *        from collapsing.
					 * @param {Object}
					 *            this RowExpander object.
					 * @param {Object}
