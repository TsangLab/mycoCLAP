...
Ext.onReady(function() {
			...
			var ds = new Ext.data.Store({
						reader : new Ext.data.ArrayReader({}, [{
										...
										// Rating dependent upon performance 0 =
										// best, 2 = worst
										{
											name : 'rating',
											type : 'int',
			...
			// the DefaultColumnModel expects this blob to define columns. It
			...
			var gridForm = new Ext.FormPanel({
						...
						items : [{
							...
							items : [{
										...
										fieldLabel : 'Rating',
										name : 'rating',
										// A radio group: A setValue on any of
										// the following 'radio' inputs using
										// the numeric
										// 'rating' field checks the radio
										// instance which has the matching
										// inputValue.
										items : [{
													inputValue : '0',
													boxLabel : 'A'
