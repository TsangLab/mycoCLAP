...
Ext.onReady(function() {
	...
	// Simple arrays can be used directly as the store config. 1-dimensional
	// arrays
	// will automatically be expanded (each array item will be the combo value
	// and text)
	// and for multi-dimensional arrays, the value in index 0 of each item will
	// be assumed
	// to be the value, while the value at index 1 is assumed to be the text.
	// For example,
	// [['AL', 'Alabama'],['AK', 'Alaska'], etc.]. Any other values beyond index
	// 1 within
