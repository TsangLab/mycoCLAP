...
Ext.onReady(function() {
	...
	// Using checkbox/radio groups will generally be easier and more flexible
	// than
	// using individual checkbox and radio controls, but this shows that you can
	// certainly do so if you only need a single control, or if you want to
	// control
	...
	var checkGroup = {
		...
		items : [{
					...
					anchor : '95%',
					items : [{
								// You can pass sub-item arrays along with
								// width/columnWidth configs
								// ColumnLayout-style for complete layout
								// control. In this example we
								// only want one item in the middle column,
								// which would not be possible
								// using the columns config. We also want to
								// make sure that our headings
	...
	var fp = new Ext.FormPanel({
				...
				items : [{
							layout : 'column',
							border : false,
							// defaults are applied to all child items unless
							// otherwise specified by child item
							defaults : {
								columnWidth : '.5',
								border : false
							},
