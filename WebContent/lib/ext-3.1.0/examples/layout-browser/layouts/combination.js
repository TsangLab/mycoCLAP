		...
		items : [{
					...
					items : [{
						...
						cls : 'inner-tab-custom', // custom styles in
													// layout-browser.css
						layout : 'border',
						// Make sure IE can still calculate dimensions after a
						...
						items : [{
									...
									activeTab : 0,
									items : [{
										// Panels that are used as tabs do not
										// have title bars since the tab
										// itself is the title container. If you
										// want to have a full title
										// bar within a tab, you can easily nest
										// another panel within the tab
										...
										// A common mistake when adding grids to
										// a layout is creating a panel first,
										// then adding the grid to it. GridPanel
										// (xtype:'grid') is a Panel subclass,
										// so you can add it directly as an item
										// into a container. Typically you will
										// want to specify layout:'fit' on
										// GridPanels so that they'll size along
										// with
										...
										// Add a listener to load the data only
