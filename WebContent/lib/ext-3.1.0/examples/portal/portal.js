...
Ext.onReady(function() {
	...
	var viewport = new Ext.Viewport({
				...
				items : [{
							...
							/*
							 * Uncomment this block to test handling of the drop
							 * event. You could use this to save portlet
							 * position state for example. The event arg e is
							 * the custom event defined in
