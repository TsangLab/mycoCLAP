...
function initializeHospitalDropZone(g) {
	g.dropZone = new Ext.dd.DropZone(g.getView().scroller, {
				...
				// provided as the "target" parameter in all "onNodeXXXX" node
				...
				// underlying
				// application object that is the real target of the dragged
				// data.
				// In this case, it is a Record in the GridPanel's Store.
				// We can use the data set up by the DragZone's getDragData
				// method to read
