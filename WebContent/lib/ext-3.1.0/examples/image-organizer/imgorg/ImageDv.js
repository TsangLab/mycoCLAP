...
Imgorg.ImageDv = Ext.extend(Ext.DataView, {
	...
	initComponent : function() {
		...
		this.on({// hacks to force the labeleditor to stop editing when we
					// get a click elsewhere
			click : function() {
	...
	afterRender : function() {
		...
		this.el.unselectable(); // messy if they can select the text of the file
								// names
	},
