...
Ext.onReady(function() {
			...
			// configure whether filtering is performed locally or remotely
			// (initially)
			var local = true;
			...
			grid.getBottomToolbar().add(['->', {
				...
				handler : function(button, state) {
					...
					grid.filters
							.cleanParams(grid.getStore().lastOptions.params);
				...
				handler : function(button, state) {
					...
					// bind the store again so GridFilters is listening to
					// appropriate store event
