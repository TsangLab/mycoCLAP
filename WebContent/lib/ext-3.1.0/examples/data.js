...
Ext.samples.samplesCatalog = [{
	...
	samples : [{
		 ...
		 * ,{ text: 'Image Organizer', url: 'image-organizer/index.html', icon:
		 * 'image-organizer.gif', desc: 'Image management application example
		 * utilizing MySQL lite and Ext.Direct.', status: 'new' }
		 */, {
