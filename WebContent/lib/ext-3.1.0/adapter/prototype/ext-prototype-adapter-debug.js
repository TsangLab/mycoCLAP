...
(function() {
	...
	var libFlyweight, version = Prototype.Version.split('.'), mouseEnterSupported = (parseInt(version[0]) >= 2)
			|| (parseInt(version[1]) >= 7) || (parseInt(version[2]) >= 1), mouseCache = {}, elContains = function(
			parent, child) {
