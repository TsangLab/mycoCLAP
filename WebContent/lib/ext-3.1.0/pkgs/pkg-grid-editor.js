...
Ext.grid.CellSelectionModel = Ext.extend(Ext.grid.AbstractSelectionModel, {
	...
	handleKeyDown : function(i) {
		...
		var d = i.getKey(), h = this.grid, o = this.selection, b = this, l = function(
				g, c, e) {
			return h.walkCells(g, c, e, h.isEditor && h.editing
							? b.acceptsNav
							: b.isSelectable, b)
		}, n, f, a, j, m;
		switch (d) {
...
Ext.grid.EditorGridPanel = Ext.extend(Ext.grid.GridPanel, {
	...
	onEditComplete : function(b, d, a) {
		...
		if (this.forceValidation === true || String(d) !== String(a)) {
			...
			if (this.fireEvent("validateedit", f) !== false && !f.cancel
					&& String(d) !== String(a)) {
				c.set(g, f.value);
				delete f.cancel;
	...
	startEditing : function(h, c) {
		...
		if (this.colModel.isCellEditable(c, h)) {
			...
			var d = this.store.getAt(h), g = this.colModel.getDataIndex(c), f = {
				grid : this,
				record : d,
				field : g,
				value : d.data[g],
			...
			if (this.fireEvent("beforeedit", f) !== false && !f.cancel) {
				...
				b.startEdit(this.view.getCell(h, c).firstChild, Ext
								.isDefined(a) ? a : "")
			}
		}
	},
