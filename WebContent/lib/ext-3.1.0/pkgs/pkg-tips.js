...
Ext.ToolTip = Ext.extend(Ext.Tip, {
	...
	getTargetXY : function() {
		...
		if (this.anchor) {
			this.targetCounter++;
			var c = this.getOffsets(), j = (this.anchorToTarget && !this.trackMouse)
					? this.el.getAlignToXY(this.anchorTarget, this
									.getAnchorAlign())
					: this.targetXY, a = Ext.lib.Dom.getViewWidth() - 5, f = Ext.lib.Dom
					.getViewHeight()
					- 5, g = document.documentElement, e = document.body, i = (g.scrollLeft
					|| e.scrollLeft || 0)
					+ 5, h = (g.scrollTop || e.scrollTop || 0) + 5, b = [
					j[0] + c[0], j[1] + c[1]];
			sz = this.getSize();
