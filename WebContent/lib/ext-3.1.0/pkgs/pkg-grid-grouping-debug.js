 ...
 *          grid. A {@link Ext.data.GroupingStore GroupingStore} must be used to
 *          enable grouping. Some grouping characteristics may also be
 *          configured at the {@link Ext.grid.Column Column level}<div
...
Ext.grid.GroupingView = Ext.extend(Ext.grid.GridView, {
	...
	/**
	 * @cfg {Boolean} hideGroupedColumn <tt>true</tt> to hide the column that
	 *      is currently grouped (defaults to <tt>false</tt>)
	 */
	hideGroupedColumn : false,
	/**
	 * @cfg {Boolean} showGroupName If <tt>true</tt> will display a prefix
	 *      plus a ': ' before the group field value in the group header line.
	 *      The prefix will consist of the
	 *      <tt><b>{@link Ext.grid.Column#groupName groupName}</b></tt> (or
	 *      the configured <tt><b>{@link Ext.grid.Column#header header}</b></tt>
	 *      if not provided) configured in the {@link Ext.grid.Column} for each
	 *      set of grouped rows (defaults to <tt>true</tt>).
	 */
	showGroupName : true,
	/**
	 * @cfg {Boolean} startCollapsed <tt>true</tt> to start all groups
	 *      collapsed (defaults to <tt>false</tt>)
	 */
	startCollapsed : false,
	/**
	 * @cfg {Boolean} enableGrouping <tt>false</tt> to disable grouping
	 *      functionality (defaults to <tt>true</tt>)
	 */
	enableGrouping : true,
	/**
	 * @cfg {Boolean} enableGroupingMenu <tt>true</tt> to enable the grouping
	 *      control in the column menu (defaults to <tt>true</tt>)
	 */
	enableGroupingMenu : true,
	/**
	 * @cfg {Boolean} enableNoGroups <tt>true</tt> to allow the user to turn
	 *      off grouping (defaults to <tt>true</tt>)
	 */
	enableNoGroups : true,
	/**
	 * @cfg {String} emptyGroupText The text to display when there is an empty
	 *      group value (defaults to <tt>'(None)'</tt>). May also be
	 *      specified per column, see {@link Ext.grid.Column}.{@link Ext.grid.Column#emptyGroupText emptyGroupText}.
	 */
	emptyGroupText : '(None)',
	/**
	 * @cfg {Boolean} ignoreAdd <tt>true</tt> to skip refreshing the view when
	 *      new rows are added (defaults to <tt>false</tt>)
	 */
	ignoreAdd : false,
	/**
	 * @cfg {String} groupTextTpl The template used to render the group header
	 *      (defaults to <tt>'{text}'</tt>). This is used to format an object
	 *      which contains the following properties: <div
	 *      class="mdetail-params">
	 *      <ul>
	 *      <li><b>group</b> : String
	 *      <p class="sub-desc">
	 *      The <i>rendered</i> value of the group field. By default this is
	 *      the unchanged value of the group field. If a
	 *      <tt><b>{@link Ext.grid.Column#groupRenderer groupRenderer}</b></tt>
	 ...
	 *      <tt>{@link #showGroupName})</tt> if
	 *      <tt>{@link #showGroupName}</tt> is <tt>true</tt>) plus the
	 *      <i>rendered</i> group field value.
	 *      </p>
	 *      </li>
	 ...
	 *      using a template. Possible usage:
	 * 
	 * <pre><code>
	 * 	var grid = new Ext.grid.GridPanel({
	 * 	...
	...
	/**
	 * @cfg {String} groupMode Indicates how to construct the group identifier.
	 *      <tt>'value'</tt> constructs the id using raw value,
	 *      <tt>'display'</tt> constructs the id using the rendered value.
	 *      Defaults to <tt>'value'</tt>.
	 */
	groupMode : 'value',

	/**
	 * @cfg {Function} groupRenderer This property must be configured in the
	 *      {@link Ext.grid.Column} for each column.
	 */
	 ...
	 * 
	 * @param {Number}
	 *            rowIndex The row inside the group
	 * @param {Boolean}
	 *            expanded (optional)
	 */
