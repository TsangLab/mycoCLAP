...
Ext.extend(Ext.data.JsonWriter, Ext.data.DataWriter, {
			/**
			 * @cfg {Boolean} returnJson <b>Deprecated, will be removed in
			 *      Ext-3.0.1</b>. Use {@link Ext.data.JsonWriter#encode}
			 *      instead.
			 */
			returnJson : undefined,
			/**
			 * @cfg {Boolean} encode <tt>true</tt> to
			 *      {@link Ext.util.JSON#encode encode} the
			 *      {@link Ext.data.DataWriter#toHash hashed data}. Defaults to
			 *      <tt>true</tt>. When using {@link Ext.data.DirectProxy},
			 *      set this to <tt>false</tt> since Ext.Direct.JsonProvider
			 *      will perform its own json-encoding. In addition, if you're
			 *      using {@link Ext.data.HttpProxy}, setting to <tt>false</tt>
			 *      will cause HttpProxy to transmit data using the <b>jsonData</b>
			 *      configuration-params of {@link Ext.Ajax#request} instead of
			 *      <b>params</b>. When using a {@link Ext.data.Store#restful}
			 *      Store, some serverside frameworks are tuned to expect data
			 *      through the jsonData mechanism. In those cases, one will
			 *      want to set <b>encode: <tt>false</tt></b>, as in let the
			 *      lower-level connection object (eg: Ext.Ajax) do the
			 *      encoding.
			 */
			encode : true,

			/**
			 * Final action of a write event. Apply the written data-object to
			 * params.
			 * 
			 * @param {Object}
			 *            http params-object to write-to.
			 * @param {Object}
			 *            baseParams as defined by
			 *            {@link Ext.data.Store#baseParams}. The baseParms must
			 *            be encoded by the extending class, eg:
			 *            {@link Ext.data.JsonWriter},
			 *            {@link Ext.data.XmlWriter}.
			 * @param {Object/Object[]}
			 *            data Data-object representing compiled
			 *            Store-recordset.
			 */
			render : function(params, baseParams, data) {
				if (this.encode === true) {
					...
					// defer encoding for some other layer, probably in {@link
					// Ext.Ajax#request}. Place everything into "jsonData" key.
 ...
 *          <p>
 *          Data reader class to create an Array of {@link Ext.data.Record}
 *          objects from a JSON packet based on mappings in a provided
 *          {@link Ext.data.Record} constructor.
 *          </p>
 *          <p>
 *          Example code:
 *          </p>
 ...
 * <b><tt>metaData</tt></b> property in the JSON data object. If the JSON
 * data object has a <b><tt>metaData</tt></b> property, a
 * {@link Ext.data.Store Store} object using this Reader will reconfigure itself
 * to use the newly provided field definition and fire its
 * {@link Ext.data.Store#metachange metachange} event. The metachange event
 * handler may interrogate the <b><tt>metaData</tt></b> property to perform
 ...
 * 
 * <p>
 * The <b><tt>metaData</tt></b> property in the JSON data object should
 * contain:
 * </p>
 * <div class="mdetail-params">
 * <ul>
 * <li>any of the configuration options for this class</li>
 * <li>a <b><tt>{@link Ext.data.Record#fields fields}</tt></b> property
 * which the JsonReader will use as an argument to the
...
Ext.data.JsonReader = function(meta, recordType) {
	 ...
	 */
	/**
	 * @cfg {String} successProperty [success] Name of the property from which
	 *      to retrieve the success attribute. Defaults to <tt>success</tt>.
	 ...
	 *      retrieve the total number of records in the dataset. This is only
...
Ext.extend(Ext.data.JsonReader, Ext.data.DataReader, {
	 ...
	 * @param {Object}
	 *            response TODO: refactor code between JsonReader#readRecords,
	 *            #readResponse into 1 method. there's ugly duplication going on
	 *            due to maintaining backwards compat. with 2.0. It's time to do
	 *            this.
	 */
	...
	/**
	 * @ignore TODO This isn't used anywhere?? Don't we want to use this where
	 *         possible instead of complex #createAccessor?
	 */
 ...
 *          <p>
 *          Data reader class to create an Array of {@link Ext.data.Record}
 *          objects from an Array. Each element of that Array represents a row
 *          of data fields. The fields are pulled into a Record object using as
 *          a subscript, the <code>mapping</code> property of the field
 *          definition if it exists, or the field's ordinal position in the
 *          definition.
 *          </p>
 *          <p>
 *          Example code:
...
Ext.data.ArrayReader = Ext.extend(Ext.data.JsonReader, {
	 ...
	 */
	/**
	 * @cfg {Number} id (optional) The subscript within row Array that provides
	 *      an ID for the Record. Deprecated. Use {@link #idIndex} instead.
	 */
	/**
	 * @cfg {Number} idIndex (optional) The subscript within row Array that
 ...
 *          Array data easier. An ArrayStore will be automatically configured
 *          with a {@link Ext.data.ArrayReader}.
 *          </p>
 *          <p>
 ...
 *          the configuration options of <b>{@link Ext.data.ArrayReader ArrayReader}</b>.
 *          </p>
 * @constructor
 * @param {Object}
 *            config
 ...
 *          <p>
 *          Small helper class to make creating {@link Ext.data.Store}s from
 *          JSON data easier. A JsonStore will be automatically configured with
 *          a {@link Ext.data.JsonReader}.
 *          </p>
 *          <p>
 *          A store configuration would be something like:
 * 
 ...
 *          <p>
 *          <b>*Note:</b> Although not listed here, this class accepts all of
 *          the configuration options of <b>{@link Ext.data.JsonReader JsonReader}</b>.
 *          </p>
 * @constructor
 * @param {Object}
 *            config
