...
Ext.FlashComponent = Ext.extend(Ext.BoxComponent, {
	/**
	 * @cfg {String} flashVersion Indicates the version the flash content was
	 *      published for. Defaults to <tt>'9.0.45'</tt>.
	 */
	flashVersion : '9.0.115',

	/**
	 * @cfg {String} backgroundColor The background color of the chart. Defaults
	 *      to <tt>'#ffffff'</tt>.
	 */
	backgroundColor : '#ffffff',

	/**
	 * @cfg {String} wmode The wmode of the flash object. This can be used to
	 *      control layering. Defaults to <tt>'opaque'</tt>.
	 */
	wmode : 'opaque',

	/**
	 * @cfg {Object} flashVars A set of key value pairs to be passed to the
	 *      flash object as flash variables. Defaults to <tt>undefined</tt>.
	 */
	flashVars : undefined,

	/**
	 * @cfg {Object} flashParams A set of key value pairs to be passed to the
	 *      flash object as parameters. Possible parameters can be found here:
	...
	/**
	 * @cfg {String} url The URL of the chart to include. Defaults to
	 *      <tt>undefined</tt>.
	 */
	url : undefined,
	swfId : undefined,
	...
	/**
	 * @cfg {Boolean} expressInstall True to prompt the user to install flash if
	 *      not installed. Note that this uses
	 *      Ext.FlashComponent.EXPRESS_INSTALL_URL, which should be set to the
...
/**
 * Sets the url for installing flash if it doesn't exist. This should be set to
 * a local resource.
 * 
 * @static
 * @type String
 ...
 * @extends Ext.FlashComponent The Ext.chart package provides the capability to
 *          visualize data with flash based charting. Each chart binds directly
 *          to an Ext.data.Store enabling automatic updates of the chart. To
 *          change the look and feel of a chart, see the {@link #chartStyle} and
 *          {@link #extraStyle} config options.
 * @constructor
 * @xtype chart
 */
...
Ext.chart.Chart = Ext.extend(Ext.FlashComponent, {
			...
			/**
			 * @cfg {Object} chartStyle Sets styles for this chart. This
			 *      contains default styling, so modifying this property will
			 *      <b>override</b> the built in styles of the chart. Use
			 *      {@link #extraStyle} to add customizations to the default
			 *      styling.
			 */
			chartStyle : {
				padding : 10,
			...
			/**
			 * @cfg {String} url The url to load the chart from. This defaults
			 *      to Ext.chart.Chart.CHART_URL, which should be modified to
			 *      point to the local charts resource.
			 */

			/**
			 * @cfg {Object} extraStyle Contains extra styles that will be added
			 *      or overwritten to the default chartStyle. Defaults to
			 *      <tt>null</tt>. For a detailed list of the options
			 *      available, visit the YUI Charts site at <a
			 *      href="http://developer.yahoo.com/yui/charts/#basicstyles">http://developer.yahoo.com/yui/charts/#basicstyles</a><br/>
			 *      Some of the options availabe:<br />
			 *      <ul style="padding:5px;padding-left:16px;list-style-type:inherit;">
			 *      <li><b>padding</b> - The space around the edge of the
			 *      chart's contents. Padding does not increase the size of the
			 *      chart.</li>
			 *      <li><b>animationEnabled</b> - A Boolean value that
			 *      specifies whether marker animations are enabled or not.
			 *      Enabled by default.</li>
			 *      <li><b>font</b> - An Object defining the font style to be
			 *      used in the chart. Defaults to
			 *      <tt>{ name: 'Tahoma', color: 0x444444, size: 11 }</tt><br/>
			 *      <ul style="padding:5px;padding-left:26px;list-style-type:circle;">
			 *      <li><b>name</b> - font name</li>
			 *      <li><b>color</b> - font color (hex code, ie: "#ff0000",
			 *      "ff0000" or 0xff0000)</li>
			 *      <li><b>size</b> - font size in points (numeric portion
			 *      only, ie: 11)</li>
			 ...
			 *      </ul>
			 *      </li>
			 *      <li><b>border</b> - An object defining the border style
			 *      around the chart. The chart itself will decrease in
			 *      dimensions to accomodate the border.<br/>
			 *      <ul style="padding:5px;padding-left:26px;list-style-type:circle;">
			 *      <li><b>color</b> - border color (hex code, ie: "#ff0000",
			 *      "ff0000" or 0xff0000)</li>
			 *      <li><b>size</b> - border size in pixels (numeric portion
			 *      only, ie: 1)</li>
			 *      </ul>
			 *      </li>
			 *      <li><b>background</b> - An object defining the background
			 *      style of the chart.<br/>
			 *      <ul style="padding:5px;padding-left:26px;list-style-type:circle;">
			 *      <li><b>color</b> - border color (hex code, ie: "#ff0000",
			 *      "ff0000" or 0xff0000)</li>
			 *      <li><b>image</b> - an image URL. May be relative to the
			 *      current document or absolute.</li>
			 *      </ul>
			 *      </li>
			 *      <li><b>legend</b> - An object defining the legend style<br/>
			 *      <ul style="padding:5px;padding-left:26px;list-style-type:circle;">
			 *      <li><b>display</b> - location of the legend. Possible
			 *      values are "none", "left", "right", "top", and "bottom".</li>
			 *      <li><b>spacing</b> - an image URL. May be relative to the
			 *      current document or absolute.</li>
			 *      <li><b>padding, border, background, font</b> - same
			 *      options as described above.</li>
			 *      </ul>
			 *      </li>
			 *      <li><b>dataTip</b> - An object defining the style of the
			 *      data tip (tooltip).<br/>
			 *      <ul style="padding:5px;padding-left:26px;list-style-type:circle;">
			 *      <li><b>padding, border, background, font</b> - same
			 *      options as described above.</li>
			 *      </ul>
			 *      </li>
			 *      <li><b>xAxis and yAxis</b> - An object defining the style
			 *      of the style of either axis.<br/>
			 *      <ul style="padding:5px;padding-left:26px;list-style-type:circle;">
			 *      <li><b>color</b> - same option as described above.</li>
			 *      <li><b>size</b> - same option as described above.</li>
			 *      <li><b>showLabels</b> - boolean</li>
			 *      <li><b>labelRotation</b> - a value in degrees from -90
			 *      through 90. Default is zero.</li>
			 *      </ul>
			 *      </li>
			 *      <li><b>majorGridLines and minorGridLines</b> - An object
			 *      defining the style of the style of the grid lines.<br/>
			 *      <ul style="padding:5px;padding-left:26px;list-style-type:circle;">
			 *      <li><b>color, size</b> - same options as described above.</li>
			 *      </ul>
			 *      </li>
			 *      </li>
			 *      <li><b>zeroGridLine</b> - An object defining the style of
			 *      the style of the zero grid line.<br/>
			 *      <ul style="padding:5px;padding-left:26px;list-style-type:circle;">
			 *      <li><b>color, size</b> - same options as described above.</li>
			 *      </ul>
			 *      </li>
			 *      </li>
			 *      <li><b>majorTicks and minorTicks</b> - An object defining
			 *      the style of the style of ticks in the chart.<br/>
			 *      <ul style="padding:5px;padding-left:26px;list-style-type:circle;">
			 *      <li><b>color, size</b> - same options as described above.</li>
			 *      <li><b>length</b> - the length of each tick in pixels
			 *      extending from the axis.</li>
			 *      <li><b>display</b> - how the ticks are drawn. Possible
			 *      values are "none", "inside", "outside", and "cross".</li>
			 *      </ul>
			 *      </li>
			 *      </li>
			 *      </ul>
			...
			/**
			 * @cfg {Object} seriesStyles Contains styles to apply to the series
			 *      after a refresh. Defaults to <tt>null</tt>.
			 */
			seriesStyles : null,

			/**
			 * @cfg {Boolean} disableCaching True to add a "cache buster" to the
			 *      end of the chart url. Defaults to true for Opera and IE.
			 */
			...
			initComponent : function() {
				...
				this.addEvents('itemmouseover', 'itemmouseout', 'itemclick',
						...
						'itemdragend',
						/**
						 * @event beforerefresh Fires before a refresh to the
						 *        chart data is called. If the beforerefresh
						 *        handler returns <tt>false</tt> the
						...
						'beforerefresh',
						/**
						 * @event refresh Fires after the chart data has been
						 *        refreshed.
						 * @param {Chart}
						 *            this
						 */
			 ...
			 * 
			 * @param name
			 *            {String} Name of the Chart style value to change.
			 * @param value
			 *            {Object} New value to pass to the Chart style.
			 */
			 ...
			 * 
			 * @param styles
			 *            {Object} Initializer for all Chart styles.
			 */
			 ...
			 * 
			 * @param styles
			 *            {Array} Initializer for all Chart series styles.
			 */
			...
			refresh : function() {
				if (this.fireEvent('beforerefresh', this) !== false) {
					...
					// convert the store data into something YUI charts can
					// understand
						...
						for (i = 0; i < seriesCount; i++) {
							...
							for (var prop in currentSeries) {
								if (prop == "style"
									...
									styleChanged = true;
									// we don't want to modify the styles again
									// next time
...
/**
 * @class Ext.chart.Axis Defines a CartesianChart's vertical or horizontal axis.
 * @constructor
 */
...
Ext.chart.Axis.prototype = {
	...
	/**
	 * The direction in which the axis is drawn. May be "horizontal" or
	 * "vertical".
	 * 
	...
	/**
	 * A string reference to the globally-accessible function that may be called
	 * to determine each of the label values for this axis.
	 * 
 ...
 * @extends Ext.chart.Axis A type of axis whose units are measured in numeric
 *          values.
 * @constructor
 */
Ext.chart.NumericAxis = Ext.extend(Ext.chart.Axis, {
			...
			/**
			 * The minimum value drawn by the axis. If not set explicitly, the
			 * axis minimum will be calculated automatically.
			 * 
			 * @property minimum
			 * @type Number
			 */
			...
			/**
			 * The maximum value drawn by the axis. If not set explicitly, the
			 * axis maximum will be calculated automatically.
			 * 
			 * @property maximum
			 * @type Number
			 */
			 ...
			 * snap to the nearest major or minor unit. If false, their position
			 * will be based on the minimum value.
			 * 
			...
			/**
			 * If true, and the bounds are calculated automatically, either the
			 * minimum or maximum will be set to zero.
			 * 
 ...
 * @extends Ext.chart.Axis A type of axis whose units are measured in time-based
 *          values.
 * @constructor
 */
 ...
 * @extends Ext.chart.Axis A type of axis that displays items in categories.
 * @constructor
 */
...
/**
 * @class Ext.chart.Series Series class for the charts widget.
 * @constructor
 */
 ...
 * @extends Ext.chart.Series CartesianSeries class for the charts widget.
 * @constructor
 */
Ext.chart.CartesianSeries = Ext.extend(Ext.chart.Series, {
			/**
			 * The field used to access the x-axis value from the items from the
			 * data source.
			 * 
			 * @property xField
			 * @type String
			...
			/**
			 * The field used to access the y-axis value from the items from the
			 * data source.
			 * 
			 * @property yField
			 * @type String
 ...
 * @extends Ext.chart.CartesianSeries ColumnSeries class for the charts widget.
 * @constructor
 */
 ...
 * @extends Ext.chart.CartesianSeries LineSeries class for the charts widget.
 * @constructor
 */
 ...
 * @extends Ext.chart.CartesianSeries BarSeries class for the charts widget.
 * @constructor
 */
 ...
 * @extends Ext.chart.Series PieSeries class for the charts widget.
 * @constructor
 */
