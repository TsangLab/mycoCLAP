...
Ext.Resizable = function(el, config) {
	...
	this.addEvents(
			/**
			 * @event beforeresize Fired before resize is allowed. Set
			 *        {@link #enabled} to false to cancel resize.
			 * @param {Ext.Resizable}
			 *            this
...
Ext.extend(Ext.Resizable, Ext.util.Observable, {
	 ...
	 */
	/**
	 * @cfg {Boolean} disableTrackOver True to disable mouse tracking. This is
	...
	draggable : false,
	/**
	 * @cfg {Number} duration Animation duration if animate = true (defaults to
	 *      0.35)
	 */
	duration : 0.35,
	/**
	 * @cfg {Boolean} dynamic True to resize the element while dragging instead
	 *      of using a proxy (defaults to false)
	 */
	dynamic : false,
	/**
	 * @cfg {String} easing Animation easing if animate = true (defaults to
	 *      <tt>'easingOutStrong'</tt>)
	 */
	 ...
	 *      (defaults to undefined). Specify either <tt>'all'</tt> or any of
	 *      <tt>'n s e w ne nw se sw'</tt>.
	 */
	handles : false,
	/**
	 * @cfg {Boolean} multiDirectional <b>Deprecated</b>. Deprecated style of
	 *      adding multi-direction resize handles.
	 */
	multiDirectional : false,
	/**
	 * @cfg {Number} height The height of the element in pixels (defaults to
	 *      null)
	 */
	height : null,
	/**
	 ...
	 *      pixels (only applies if <code>{@link #dynamic}==true</code>).
	 *      Defaults to <tt>0</tt>.
	 */
	heightIncrement : 0,
	/**
	 * @cfg {Number} widthIncrement The increment to snap the width resize in
	 *      pixels (only applies if <code>{@link #dynamic}==true</code>).
	 *      Defaults to <tt>0</tt>.
	 */
	widthIncrement : 0,
	/**
	 * @cfg {Number} minHeight The minimum height for the element (defaults to
	 *      5)
	 */
	minHeight : 5,
	/**
	...
	maxHeight : 10000,
	/**
	 * @cfg {Number} maxWidth The maximum width for the element (defaults to
	 *      10000)
	 */
	maxWidth : 10000,
	/**
	...
	preserveRatio : false,
	/**
	 * @cfg {Boolean/String/Element} resizeChild True to resize the first child,
	 *      or id/element to resize (defaults to false)
	 */
	resizeChild : false,
	/**
	 * @cfg {Boolean} transparent True for transparent handles. This is only
	 *      applied at config time. (defaults to false)
	 */
	transparent : false,
	/**
	 * @cfg {Ext.lib.Region} resizeRegion Constrain the resize to a particular
	 *      region
	 */
	/**
	 * @cfg {Boolean} wrap True to wrap an element with a div if needed
	 *      (required for textareas and images, defaults to false) in favor of
	 *      the handles config option (defaults to false)
	 */
	 ...
	 * </p>
	 * <p>
	 * If a Resizable is being used to resize an Element which encapsulates a
	 * more complex UI component such as a Panel, this method may be overridden
	 * by specifying an implementation as a config option to provide appropriate
	 * behaviour at the end of the resize operation on mouseup, for example
	 * resizing the Panel, and relaying the Panel's content.
	 * </p>
	 * <p>
	 * The new area to be resized to is available by examining the state of the
	 * {@link #proxy} Element. Example:
	 * 
	 * <pre><code>
	 * new Ext.Panel({
	 * 			title : 'Resize me',
	...
	onMouseMove : function(e) {
		if (this.enabled && this.activeHandle) {
			try {// try catch so if something goes wrong the user doesn't get
					// hung
	...
	/**
	 * Destroys this resizable. If the element was wrapped and removeEl is not
	 * true then the element remains.
	 * 
	 * @param {Boolean}
	 *            removeEl (optional) true to remove the element from the DOM
	 */
